...
namespace Com.LuisPedroFonseca.ProCamera2D
{
    ...
    public class ProCamera2DTriggerInfluenceEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            proCamera2DTriggerInfluence.receiverObject = (GameObject)EditorGUILayout.ObjectField("Receiver object", 
                                                            proCamera2DTriggerInfluence.receiverObject, typeof(GameObject), true);
            proCamera2DTriggerInfluence.message = EditorGUILayout.TextField("Message", proCamera2DTriggerInfluence.message);
